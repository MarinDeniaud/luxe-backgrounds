...
source /cvmfs/beam-physics.cern.ch/bdsim/x86_64-centos7-gcc11-opt/bdsim-env-v1.7.0-g4v10.7.2.3-ftfp-boost.sh
...
/scratch2/mdeniaud/phd/luxe-backgrounds/03_bdsimModel/bdsimAnalysisJob_needle.py -i ${INPUTFILE} -o ${OUTPUTFILE} -p ${NGEN} -s ${SEEDVALUE}
